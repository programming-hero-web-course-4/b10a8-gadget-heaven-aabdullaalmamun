    ...
    return (
        ...
        <div>
           ...
           <div className="bg-[#9538E2] max-w-[1540px] mx-auto rounded-3xl relative bottom-16 pt-10">
            ...
            <h1 className="text-center text-6xl text-white font-bold mt-10">Upgrade Your Tech Accessorize with <br /> Gadget Heaven Accessories</h1>
        ...
        <div className="relative bottom-45">
                <img className="mx-auto w-3xl max-h-[400px] rounded-2xl" src="../../../src/assets/banner.jpg" alt="" />
            </div>
